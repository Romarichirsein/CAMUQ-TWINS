...
let database = {
  ...
  products: [
    ...
    { id: "p-2", name: "Dentifrice Longrich au thé blanc (Sans Fluor)", category: "longrich", price: 4000, unit: "tube 200g", image: "/images/dentifrice-longrich.jpg", description: "Pâte au thé blanc sans fluor. Blanchit les dents, rafraîchit l'haleine et prévient les caries.", available: true },
    { id: "p-3", name: "Gobelet Alcalin de Santé Longrich", category: "longrich", price: 50000, unit: "gobelet", image: "/images/gobelet-alcalin-longrich.jpg", description: "Transforme l'eau en eau alcaline saine (2L/jour). Purifie l'organisme et régule la tension.", available: true },
    { id: "p-6", name: "Savon Noir au Charbon de Bambou Longrich", category: "longrich", price: 4000, unit: "boîte (3 savons)", image: "/images/savon-charbon-longrich.jpg", description: "Nettoyant et exfoliant. Élimine acné, taches, boutons et excès de sébum.", available: true },
    { id: "p-7", name: "Lait de Corps SOD Longrich (Sheep Placenta)", category: "longrich", price: 6000, unit: "flacon 200ml", image: "/images/lait-sod-longrich.jpg", description: "Soin hydratant intense au placenta de brebis. Protège, unifie et illumine le teint.", available: true },
    { id: "p-8", name: "Spray Anti-Moustique Longrich", category: "longrich", price: 4500, unit: "flacon 175ml", image: "/images/spray-antimoustique-longrich.jpg", description: "Protection de 08 heures contre les piqûres. Formule douce et non irritante.", available: true },
    { id: "p-9", name: "Huile de Serpent Longrich (Snake Oil)", category: "longrich", price: 7500, unit: "flacon 80ml", image: "/images/huile-de-serpent-longrich.jpg", description: "Hydrate, traite les vergetures, l'acné, la chute de cheveux et apaise les douleurs articulaires.", available: true },
    { id: "p-10", name: "Déodorant Anti-Transpirant Roll-On Longrich", category: "longrich", price: 3500, unit: "flacon 50ml", image: "/images/deodorant-longrich.jpg", description: "Supprime les odeurs, prévient les démangeaisons et offre une fraîcheur longue durée.", available: true },
    { id: "p-5", name: "Calcium Longrich (Manganèse, Zinc)", category: "longrich", price: 12500, unit: "boîte 100 tab", image: "https://images.unsplash.com/photo-1584017911766-d451b3d0e843?q=80&w=600&auto=format&fit=crop", description: "Supplément nutritionnel pour fortifier les os et les dents.", available: true },
